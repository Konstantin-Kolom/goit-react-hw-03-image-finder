...
export class App extends Component {
  ...
  render() {
    const { searchQuery, arrImages, loading, showModal, largeSrc, error } = this.state;
    ...
    return (
      <div className={css.App}>
        ...
        {error && <h2 className={css.ErrorTitle}>Search result '{searchQuery}' not found!</h2>}
        ...
        {showModal && <Modal largeSrc={largeSrc} alt={searchQuery} onClose={this.closeModal} />}
      </div>
    );
  }
}
